...
- **The Blue Team (The Learner)**: Your small base model (e.g., Qwen2.5-0.5B), fine-tuned via the GRPOTrainer. It observes ambiguous alerts and executes security tools.
...
👉 **[View the Google Colab TRL + GRPO Training Notebook Here](https://colab.research.google.com/drive/your-link-here)**
